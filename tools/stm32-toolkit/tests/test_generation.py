...
@pytest.mark.parametrize(
    ...
    [
        ...
        (b"{}", "version"),
        (b'{"extra": 1}', "key"),
        (b'{"schemaVersion":2,"tool":"stm32-toolkit","toolVersion":"0.4.0","templateVersion":1,"projectManifestSha256":"' + b"a" * 64 + b'","files":[]}', "version"),
        (b'{"schemaVersion":1,"tool":"other","toolVersion":"0.4.0","templateVersion":1,"projectManifestSha256":"' + b"a" * 64 + b'","files":[]}', "tool"),
        (b'{"schemaVersion":1,"tool":"stm32-toolkit","toolVersion":"9.9.9","templateVersion":1,"projectManifestSha256":"' + b"a" * 64 + b'","files":[]}', "version"),
        (b'{"schemaVersion":1,"tool":"stm32-toolkit","toolVersion":"0.4.0","templateVersion":2,"projectManifestSha256":"' + b"a" * 64 + b'","files":[]}', "version"),
        (b'{"schemaVersion":1,"tool":"stm32-toolkit","toolVersion":"0.4.0","templateVersion":1,"projectManifestSha256":"zzz","files":[]}', "hash"),
        (b'{"schemaVersion":1,"tool":"stm32-toolkit","toolVersion":"0.4.0","templateVersion":1,"projectManifestSha256":"' + b"a" * 64 + b'","files":{}}', "type"),
        (b'{"schemaVersion":1,"tool":"stm32-toolkit","toolVersion":"0.4.0","templateVersion":1,"projectManifestSha256":"' + b"a" * 64 + b'","files":[1]}', "type"),
    ],
)
