...
def inspect_keil(
    ...
    out_dir = _normalize_keil_path(
        _text_of(common, "OutputDirectory"), base_dir, canonical_root, "outputDirectory"
    )
    listing_dir = _normalize_keil_path(
        _text_of(common, "ListingPath"), base_dir, canonical_root, "listingDirectory"
    )
    out_name_raw = _text_of(common, "OutputName")
